...
var nextAlbumId=index;
 ...
 $.post("ajaxDoc/ajaxWenmingMonitor.php",{"Did":nextAlbumId},function(data){
  ...
  $(".roomList").empty();
   ...
   str="<li class=\"rlist\" id=\"roomlist"+
	dataobj[i+1][0]["outId"]+"\" ><div class=\"listcap\">"+dataobj[i+1][2]["outName"]+"</div>"
	+"<div class=\"monp\">"
	+"<div class=\"monitorp\">大头贴：<img class=\"pheader\"src=\""+dataobj[i+1][4]["headerUrl"]+"\"></div>"
	+"<div class=\"monitorp\">寝室："+dataobj[i+1][1]["roomId"]+"</div>"
	
	+"<div class=\"planp\">个人简介："+dataobj[i+1][3]["intro"]+"</div>"
	+"<div class=\"editRecord\"><a href=\"changeRecordPerson.php?pra=person&pid="+dataobj[i+1][0]["outId"]+"\">修改</a></div>"
    /* str="<li class=\"rlist\" id=\"roomlist"+
...
<div class="righttop">
<img id="righttop"height="45px" width="700px" src="static/image/monitor.jpg">
<div class="room">
